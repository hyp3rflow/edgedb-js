import type { ArrayType, BaseType, BaseTypeTuple, BaseTypeToTsType, cardinalityUtil, Cardinality, EnumType, LinkDesc, NamedTupleType, ObjectType, ObjectTypeSet, PrimitiveTypeSet, PropertyDesc, ScalarType, TupleType, TypeSet } from "../reflection/index";
import type { scalarCastableFrom, scalarAssignableBy } from "@generated/castMaps";
