...
declare type $jsonDestructure<Set extends TypeSet> = Set["__element__"] extends ScalarType<"std::json"> ? {
    [path: string]: $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<Set["__element__"], Set["__cardinality__"]>>;
} & {
    destructure<T extends TypeSet<ScalarType<"std::str">> | string>(path: T): $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<Set["__element__"], cardinalityUtil.multiplyCardinalities<Set["__cardinality__"], T extends TypeSet ? T["__cardinality__"] : Cardinality.One>>>;
} : unknown;
...
export declare type assert_single<Expr extends TypeSet> = Expression<{
...
export declare type stripNonInsertables<T extends ObjectTypePointers> = {
    [k in keyof T]: [T[k]["computed"]] extends [true] ? never : [k] extends ["__type__"] ? never : [k] extends ["id"] ? never : T[k];
};
...
declare type $arrayLikeIndexify<Set extends TypeSet> = Set["__element__"] extends ArrayType | ScalarType<"std::str"> | ScalarType<"std::bytes"> ? {
    [index: number]: $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"] extends ArrayType<infer El> ? El : Set["__element__"]>, Set["__cardinality__"]>>;
    [slice: `${number}:${number | ""}` | `:${number}`]: $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"]>, Set["__cardinality__"]>>;
    index<T extends TypeSet<ScalarType<"std::number">> | number>(index: T): $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"] extends ArrayType<infer El> ? El : Set["__element__"]>, cardinalityUtil.multiplyCardinalities<Set["__cardinality__"], T extends TypeSet ? T["__cardinality__"] : Cardinality.One>>>;
    slice<S extends TypeSet<ScalarType<"std::number">> | number, E extends TypeSet<ScalarType<"std::number">> | number | undefined | null>(start: S, end: E): $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"]>, cardinalityUtil.multiplyCardinalities<cardinalityUtil.multiplyCardinalities<Set["__cardinality__"], S extends TypeSet ? S["__cardinality__"] : Cardinality.One>, E extends TypeSet ? E["__cardinality__"] : Cardinality.One>>>;
    slice<E extends TypeSet<ScalarType<"std::number">> | number | undefined | null>(start: undefined | null, end: E): $expr_Operator<"[]", OperatorKind.Infix, [
        Set,
        TypeSet
    ], TypeSet<getPrimitiveBaseType<Set["__element__"]>, cardinalityUtil.multiplyCardinalities<Set["__cardinality__"], E extends TypeSet ? E["__cardinality__"] : Cardinality.One>>>;
} : unknown;
...
export declare type ParamType = ScalarType | ArrayType<ScalarType | TupleType<typeutil.tupleOf<ParamType>> | NamedTupleType<{
    [k: string]: ParamType;
}>> | TupleType<typeutil.tupleOf<ParamType>> | NamedTupleType<{
    [k: string]: ParamType;
}>;
export {};
