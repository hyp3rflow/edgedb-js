...
exports.stashPath = exports.ResolvedConnectConfig = exports.parseConnectArguments = exports.validTlsSecurityValues = void 0;
...
async function parseConnectArguments(opts = {}) {
    ...
    return {
        ...
        waitUntilAvailable: (_a = opts.waitUntilAvailable) !== null && _a !== void 0 ? _a : 30000,
        logging: (_b = opts.logging) !== null && _b !== void 0 ? _b : true,
    };
}
    ...
    setTlsSecurity(tlsSecurity, source) {
        return this._setParam("tlsSecurity", tlsSecurity, source, (_tlsSecurity) => {
            if (!exports.validTlsSecurityValues.includes(_tlsSecurity)) {
                throw new Error(`invalid 'tlsSecurity' value: '${_tlsSecurity}', ` +
            ...
            if (clientSecurity !== undefined) {
                if (!["default", "insecure_dev_mode", "strict"].includes(clientSecurity)) {
                    throw new Error(`invalid EDGEDB_CLIENT_SECURITY value: '${clientSecurity}', ` +
                ...
                if (clientSecurity === "insecure_dev_mode") {
                    ...
                    if (_tlsSecurity === "insecure" ||
                        ...
                        throw new Error(`'tlsSecurity' value (${_tlsSecurity}) conflicts with ` +
...
async function resolveConfigOptions(resolvedConfig, config, sources, compoundParamsError) {
    ...
    if (config.tlsCA != null && config.tlsCAFile != null) {
        throw new Error(`Cannot specify both ${sources.tlsCA} and ${sources.tlsCAFile}`);
    }
    anyOptionsUsed =
    ...
    resolvedConfig.addServerSettings((_g = config.serverSettings) !== null && _g !== void 0 ? _g : {});
    const compoundParamsCount = [
        config.dsn,
        config.instanceName,
        config.credentials,
        config.credentialsFile,
        (_h = config.host) !== null && _h !== void 0 ? _h : config.port,
    ...
    if (compoundParamsCount === 1) {
        if (config.dsn !== undefined ||
            ...
            if (config.credentials != null) {
                ...
                if (credentialsFile === undefined) {
                    if (!/^[A-Za-z_][A-Za-z_0-9]*$/.test(config.instanceName)) {
                        throw new Error(`invalid DSN or instance name: '${config.instanceName}'`);
                    }
            ...
            resolvedConfig.setHost((_j = creds.host) !== null && _j !== void 0 ? _j : null, source);
            resolvedConfig.setPort((_k = creds.port) !== null && _k !== void 0 ? _k : null, source);
            resolvedConfig.setDatabase((_l = creds.database) !== null && _l !== void 0 ? _l : null, source);
            resolvedConfig.setUser((_m = creds.user) !== null && _m !== void 0 ? _m : null, source);
            resolvedConfig.setPassword((_o = creds.password) !== null && _o !== void 0 ? _o : null, source);
            resolvedConfig.setTlsCAData((_p = creds.tlsCAData) !== null && _p !== void 0 ? _p : null, source);
            resolvedConfig.setTlsSecurity((_q = creds.tlsSecurity) !== null && _q !== void 0 ? _q : null, source);
        }
...
async function parseDSNIntoConfig(_dsnString, config, source) {
    ...
    async function handleDSNPart(paramName, value, currentValue, setter, formatter = val => val) {
        ...
        if ([
            ...
            throw new Error(`invalid DSN: more than one of ${value !== null ? `'${paramName}', ` : ""}'?${paramName}=', ` +
        ...
        if (currentValue === null) {
            ...
            if (param === null) {
                ...
                if (env != null) {
                    ...
                    if (param === null) {
                        throw new Error(`'${paramName}_env' environment variable '${env}' doesn't exist`);
                    }
