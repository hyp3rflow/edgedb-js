...
exports.RelativeDurationCodec = exports.DurationCodec = exports.LocalTimeCodec = exports.LocalDateCodec = exports.LocalDateTimeCodec = exports.DateTimeCodec = void 0;
...
class DurationCodec extends ifaces_1.ScalarCodec {
    encode(buf, object) {
        ...
        for (const field of unencodableDurationFields) {
            if (object[field] !== 0) {
                throw new Error(`Cannot encode a 'Duration' with a non-zero number of ${field}`);
            }
        }
